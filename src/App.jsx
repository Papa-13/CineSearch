...
const SHOWS = [
  ...
  { id:31, title:"Kung Fu Panda", emoji:"🐼", accent:"#D4A800", bg:"#0d0900", words:{
    easy:  ["PO","SHIFU","TIGRESS","CRANE","MANTIS","VIPER","MONKEY","OOGWAY","VALLEY","PANDA","DRAGON","SCROLL","NOODLES","CHINA","MASTER"],
    hard:  ["TAILUNG","SHEN","KAI","FURIOUS","PEACH","TREE","JADE","PALACE","VILLAIN","WARRIOR","DUMPLING","FIVE","RHINO","CROC","WOLF"],
    expert:["SOOTHSAYER","THUNDERING","CHORH","GORM","TEMUTAI","FENGHUANG","COMMANDER","STORMING","PORCUPINE","TOAD","BOAR","BOSS","FLYING","WUXI","FINGER"],
  }},
];
...
export default function WordSearch(){
  ...
  const SECTIONS=[
    ...
    {label:'🏰 Disney',          color:T.sectionColor.disney,    ids:[20,21,26,30]},
    {label:'🤖 Pixar',           color:T.sectionColor.pixar,     ids:[22,23,24,27,29]},
    {label:'🐉 DreamWorks',      color:T.sectionColor.dreamworks, ids:[25,28,31]},
  ];
